...
// Source: github.com/ozonmp/com-message-api/internal/app/repo (interfaces: EventRepo)
...
import (
	...
	model "github.com/ozonmp/com-message-api/internal/model"
	reflect "reflect"
)
...
func (m *MockEventRepo) Add(arg0 model.MessageEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockEventRepo) Lock(arg0 uint64) ([]model.MessageEvent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Lock", arg0)
	ret0, _ := ret[0].([]model.MessageEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
